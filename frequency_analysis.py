class Note():
    ...
    def get_note_from_frequency(self, frequency):
        # List of note names and their corresponding frequencies
        note_frequencies = [("C0", 16.35), ("C#0/Db0", 17.32), ("D0", 18.35), ("D#0/Eb0", 19.45), ("E0", 20.60), ("F0", 21.83), ("F#0/Gb0", 23.12), ("G0", 24.50), ("G#0/Ab0", 25.96), ("A0", 27.50), ("A#0/Bb0", 29.14), ("B0", 30.87),
            ...
            ("C9", 8372.02), ("C#9/Db9", 8869.84), ("D9", 9397.27), ("D#9/Eb9", 9956.06), ("E9", 10548.08), ("F9", 11175.30), ("F#9/Gb9", 11839.82), ("G9", 12543.85), ("G#9/Ab9", 13289.75), ("A9", 14080.00), ("A#9/Bb9", 14917.24), ("B9", 15804.27),
            ("C10", 16744.04)]

        # Find the closest note
        closest_note = min(note_frequencies, key=lambda note: abs(note[1] - frequency))
